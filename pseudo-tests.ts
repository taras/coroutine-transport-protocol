 ...
 *
 * These tests describe the behavior we want to implement: Effection's
 * structured concurrency with durability via Durable Streams. They are
 * not yet runnable — they describe workflow code, expected stream
 * contents, and resume behavior.
 *
 * ═══════════════════════════════════════════════════════════════════
 * REFERENCES
 * ═══════════════════════════════════════════════════════════════════
 ...
 *     - Emits ScopeEvents whenever scopes are created/destroyed/modified.
